...
Swipeable.propTypes = {
  ...
  // styles
  style: _propTypes.shape({style: _propTypes.PropTypes.any}),
  leftContainerStyle: _propTypes.shape({style: _propTypes.PropTypes.any}),
  leftButtonContainerStyle: _propTypes.shape({style: _propTypes.PropTypes.any}),
  rightContainerStyle: _propTypes.shape({style: _propTypes.PropTypes.any}),
  rightButtonContainerStyle: _propTypes.shape({style: _propTypes.PropTypes.any}),
  contentContainerStyle: _propTypes.shape({style: _propTypes.PropTypes.any})
};
